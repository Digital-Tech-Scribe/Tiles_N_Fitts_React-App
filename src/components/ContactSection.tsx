...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="flex flex-col md:flex-row min-h-screen transition-colors duration-300">
      {/* Left - Form */}
      <div className="w-full md:w-1/2 px-6 md:px-24 py-24 flex flex-col justify-center bg-warm-light dark:bg-zinc-900 transition-colors duration-300">
        ...
        <form className="space-y-8 max-w-md" onSubmit={sendForm}>
          <div className="space-y-2">
            ...
            <input 
              ...
              className="w-full bg-warm-charcoal/5 dark:bg-zinc-800 border-none p-4 focus:ring-1 focus:ring-zinc-900 dark:focus:ring-white text-zinc-900 dark:text-white transition-colors" 
            />
          </div>
